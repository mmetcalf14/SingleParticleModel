...
void CorrMat::SetEnergyMat()
{
    B_mat= MatrixXd::Zero(Nsite, Nsite);
    
    B_mat.topLeftCorner(Np, Np) = MatrixXd::Identity(Np,Np);
    
    //cout << "B_mat: " << B_mat << endl;
}
...
void CorrMat::RungeKuttaOnCMat(const Hamiltonian& h, ofstream &fout, double dt, double N_it, double Phi_max, double t_p)
{
